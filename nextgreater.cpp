...
//O(2N).. BAHR WALA LOOP KI N..AUR ANDAR WALA WHILE LOOP..KABHII 1 BAR KBHI 2 BAAR---KBHI N-1 BAR CHLEGA
//TO USKA SUMMATION N TIMES TOT TOTAL..O(N+N)..==O(2N)...not..o(n^2)..silly..
